      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-800 text-sm sm:text-base">Phone: (123) 456-7890</li>
              <li className="text-gray-800 text-sm sm:text-base">Email: info@petstore.com</li>
              <li className="text-gray-800 text-sm sm:text-base">Address: 123 Pet Street, City, State</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="text-gray-800 hover:text-white" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-facebook-f"></i>
              </a>
              <a href="https://instagram.com" className="text-gray-800 hover:text-white" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-instagram"></i>
              </a>
              <a href="https://twitter.com" className="text-gray-800 hover:text-white" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-twitter"></i>
              </a>
              <a href="https://linkedin.com" className="text-gray-800 hover:text-white" target="_blank" rel="noopener noreferrer">
