...
const  Pets=async()=>{
  ...
  // Function to open modal and set the selected pet
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-6">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-black mb-8">Adopt Your New Best Friend</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {pets.map((pet) => (
            <div key={pet._id} className="flex flex-col items-center justify-center bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 duration-300">
              ...
              {/* Buy Button */}
              <button
                className="bg-gray-800 text-white px-6 py-2 rounded-lg hover:bg-gray-700 transition duration-300 w-full"
